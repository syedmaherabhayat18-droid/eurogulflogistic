...
function Index() {
  ...
  return (
    <>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {CORE_SERVICES.map((service, i) => (
            <motion.article
              ...
              className="group overflow-hidden rounded border border-border bg-card shadow-industrial transition-all duration-300 hover:-translate-y-1 hover:shadow-lift"
            >
              ...
              <div className="corner-tick relative p-6">
      ...
      {/* Trust grid */}
      <section className="surface-navy blueprint-grid">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {TRUST.map((item) => (
              <div key={item.title} className="rounded border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
